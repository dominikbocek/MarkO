...
if(parametry.typzobrazeni == "normální") {
    ...
    parametry.data = parametry.koalice ? predpona + "volebni_okrsky-simple-data2.json" : predpona + "volebni_okrsky-simple-data.json"
    if(parametry.lokalita == "obec") {parametry.statistiky = predpona + "statistics.csv"} else if(parametry.lokalita = "stát") {parametry.statistiky = "statistics-obce.csv"}
    parametry.legendazdroj = parametry.koalice ? predpona + "vysledky_cr2.json" : predpona + "vysledky_cr.json"
