if [ "$1" == "-n" ]; then
    ...
    ogr2ogr -t_srs EPSG:4326 -lco ENCODING=UTF-8 "$adresar_voleb/okrsky.shp" "$adresar_okrsku/$zdroj/okrsky.shp"
    ...
    python3 "$adresar_instalace/legenda.py" --volby "$2" --dosouboru True
fi
